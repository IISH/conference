        ...
        <form method="post" action="#">           
          <fieldset class="form">
            <div class="${hasErrors(bean: eventDate, field: 'yearCode', 'error')} required">
              ...
              <input id="EventDate.yearCode" maxlength="20" name="EventDate.yearCode" value="${eventDate?.yearCode}" class="property-value" type="text" required="required" />
            </div>
            <div class="${hasErrors(bean: eventDate, field: 'startDate', 'error')} ">
              ...
              <input id="EventDate.startDate" placeholder="${g.message(code: 'default.date.form.format').toLowerCase()}" name="EventDate.startDate" value="${g.formatDate(formatName: 'default.date.form.format', date: eventDate?.startDate)}" class="property-value datepicker" type="text" />
            </div>
            <div class="${hasErrors(bean: eventDate, field: 'endDate', 'error')} ">
              ...
              <input id="EventDate.endDate" placeholder="${g.message(code: 'default.date.form.format').toLowerCase()}" name="EventDate.endDate" value="${g.formatDate(formatName: 'default.date.form.format', date: eventDate?.endDate)}" class="property-value datepicker" type="text" />
            </div>
            ...
            <div class="${hasErrors(bean: eventDate, field: 'longDescription', 'error')} ">
              ...
              <textarea id="EventDate.longDescription" cols="40" name="EventDate.longDescription" class="property-value" rows="5">${eventDate?.longDescription}</textarea>
            </div>
            <div class="${hasErrors(bean: eventDate, field: 'enabled', 'error')} ">
              ...
              <g:checkBox id="EventDate.enabled" name="EventDate.enabled" value="${eventDate?.enabled}" class="property-value" />
            </div>
          </fieldset>
