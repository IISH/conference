...
var autoCompleteWait = [];
var intervalParticipants = setInterval(function() {
    if (autoCompleteData !== undefined) {        
        clearInterval(intervalParticipants);
        for (var i=0; i<autoCompleteWait.length; i++) {
           addAutoComplete(autoCompleteWait[i]); 
        }
    }
}, 100);

$.getJSON(guessUrl('participant/participants'), function(data) {
    autoCompleteData = {
