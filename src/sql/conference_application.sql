...
--
-- Host: localhost
-- Generation Time: Jun 11, 2012 at 05:00 PM
...
CREATE TABLE IF NOT EXISTS `sent_emails` (
  ...
  `user_id` bigint(20) NOT NULL,
  `date_id` bigint(20) default NULL,
  `from_name` varchar(30) collate utf8_unicode_ci NOT NULL,
...
INSERT INTO `sent_emails` (`sent_email_id`, `user_id`, `date_id`, `from_name`, `from_email`, `subject`, `body`, `date_time_sent`, `num_tries`, `enabled`, `deleted`) VALUES
(2, 2, 13, 'eca', 'em@em.com', 'Paper accepted', 'Dear Mr. Jansen Jan,\r\n\r\nYou paper is accepted!\r\n\r\nWith kind regards,\r\nMr. Jansen Jan', NULL, 3, 1, 0),
(3, 2, 13, 'eca', 'esshc@iisg.nl', 'Paper accepted', 'Dear Mr. Jansen Jan,\r\n\r\nYou paper is accepted!\r\n\r\nWith kind regards,\r\nMr. Jansen Jan', NULL, 3, 1, 0),
(4, 2, 13, 'eca', 'esshc@iisg.nl', 'Paper accepted', 'Dear Mr. Jansen Jan,\r\n\r\nYou paper is accepted!\r\n\r\nWith kind regards,\r\nMr. Jansen Jan', NULL, 3, 1, 0),
(5, 2, 13, 'eca', 'esshc@iisg.nl', 'Paper accepted', 'Dear Mr. Jansen Jan,\r\n\r\nYou paper is accepted!\r\n\r\nWith kind regards,\r\nMr. Jansen Jan', NULL, 3, 1, 0),
(6, 2, 13, 'eca', 'esshc@iisg.nl', 'Paper accepted', 'Dear Mr. Jansen Jan,\r\n\r\nYou paper is accepted!\r\n\r\nWith kind regards,\r\nMr. Jansen Jan', NULL, 3, 1, 0);
...
(2, 'testeca2@knoex.com', 'Jan', 'Jansen', 'M', 'Mr.', 'Address number\r\nPostal code', 'City', 29, 'nl', 'e25aad0f7d9d00d2bc7d1ee8754cf7610e22edc1e5be813d3866263a5b2f483eac7891e74315a727bf79b6bdbb12d92073bdf4fdc273dafec771ec1c1e4fbfdf', 'our05jbtovlvgpqsmsisji9v3t', '0123456789', NULL, '0123456789', 'organisation', 'department', 'No extra information', '2012-04-26', 1, 0),
(3, 'testeca3@knoex.com', 'Kees', 'Kees', 'F', NULL, NULL, 'Another City', 1, 'en', '9ff3d4a2607fce38eda4f17a2a86ecb4b2bdb598659540f132ec71066650a9590a66d4e658b61cb4823e9304ed8a916171426a51542c42104969ca9c231fd707', 'tc9u3d1rs1rtuoe2rv79hllv7h', NULL, NULL, NULL, NULL, NULL, NULL, '2012-04-26', 1, 0),
