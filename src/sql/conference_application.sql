...
(43, 'default.overview.label', 'emailtemplate.label', 'Show email template', 'email', 'show', NULL, NULL, 1, 0),
...
INSERT INTO `participant_types` (`participant_type_id`, `event_id`, `type`, `with_paper`, `enabled`, `deleted`) VALUES
(1, 1, 'Chair', 0, 1, 0),
(2, 1, 'Organizer', 0, 1, 0),
(3, 1, 'Author', 1, 1, 0),
(4, 1, 'Co-Author', 0, 1, 0),
(5, 1, 'Discussant', 0, 1, 0),
(6, 3, 'Author', 1, 1, 0),
(7, 3, 'Chair', 0, 1, 0);
...
(5, 10, 'NS', 'Nieuwe sessoe', NULL, 1, 0);
