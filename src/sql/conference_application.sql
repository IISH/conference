...
--
-- Host: localhost
-- Generation Time: Jun 06, 2012 at 05:36 PM
...
(21, '<table domain="Network" index="true">\r\n	<column name="name" />\r\n	<column name="showOnline" />\r\n	<column name="showInternal" />\r\n</table>\r\n\r\n<buttons>\r\n	<button type="back" />\r\n	<button action="create" />\r\n</buttons>\r\n', '<div class="tbl_container">\n  <input type="hidden" name="default-action" value="show" />\n  <div class="tbl_toolbar right">\n    <span>Export data: </span>\n    <select class="export-data">\n      <option value="-1"> </option>\n      <option value="export=0&amp;format=csv&amp;sep=,">CSV (,)</option>\n      <option value="export=0&amp;format=csv&amp;sep=;">CSV (;)</option>\n      <option value="export=0&amp;format=csv&amp;sep=tab">CSV (tab)</option>\n      <option value="export=0&amp;format=xls">XLS</option>\n      <option value="export=0&amp;format=xml">XML</option>\n    </select>\n  </div>\n  <table class="clear">\n    <thead>\n      <tr>\n        <th class="counter"></th>\n        <th class="id hidden"></th>\n        <th class="sortable">\n          <eca:fallbackMessage code="network.name.label" fbCode="network.name.label" />\n          <eca:linkAllParams params="[''sort_0_name'': ''asc'']">\n            <g:img dir="images/skin" file="sorted_asc.gif" class="sort_asc" />\n          </eca:linkAllParams>\n          <eca:linkAllParams params="[''sort_0_name'': ''desc'']">\n            <g:img dir="images/skin" file="sorted_desc.gif" class="sort_desc" />\n          </eca:linkAllParams>\n        </th>\n        <th class="sortable">\n          <eca:fallbackMessage code="network.showOnline.label" fbCode="network.showonline.label" />\n          <eca:linkAllParams params="[''sort_0_showOnline'': ''asc'']">\n            <g:img dir="images/skin" file="sorted_asc.gif" class="sort_asc" />\n          </eca:linkAllParams>\n          <eca:linkAllParams params="[''sort_0_showOnline'': ''desc'']">\n            <g:img dir="images/skin" file="sorted_desc.gif" class="sort_desc" />\n          </eca:linkAllParams>\n        </th>\n        <th class="sortable">\n          <eca:fallbackMessage code="network.showInternal.label" fbCode="network.showinternal.label" />\n          <eca:linkAllParams params="[''sort_0_showInternal'': ''asc'']">\n            <g:img dir="images/skin" file="sorted_asc.gif" class="sort_asc" />\n          </eca:linkAllParams>\n          <eca:linkAllParams params="[''sort_0_showInternal'': ''desc'']">\n            <g:img dir="images/skin" file="sorted_desc.gif" class="sort_desc" />\n          </eca:linkAllParams>\n        </th>\n      </tr>\n      <tr>\n        <th class="counter"></th>\n        <th class="id hidden"></th>\n        <th class="filter" value="${params.filter_0_name}">\n          <input type="text" name="filter_0_name" value="${params.filter_0_name}" placeholder="Filter on ${eca.fallbackMessage(code: ''network.name.label'', fbCode: ''network.name.label'').toLowerCase()}" />\n        </th>\n        <th class="filter" value="${params.filter_0_showOnline}">\n          <eca:booleanSelect name="filter_0_showOnline" value="${params.filter_0_showOnline}" />\n        </th>\n        <th class="filter" value="${params.filter_0_showInternal}">\n          <eca:booleanSelect name="filter_0_showInternal" value="${params.filter_0_showInternal}" />\n        </th>\n      </tr>\n    </thead>\n    <tbody>\n      <g:each in="${results.get(0).get()}" var="row" status="i">\n        <tr>\n          <td class="counter">${i+1}</td>\n          <td class="id hidden">\n            <g:fieldValue bean="${row}" field="id" />\n          </td>\n          <td>${row.name}</td>\n          <td>\n            <g:formatBoolean boolean="${row.showOnline}" />\n          </td>\n          <td>\n            <g:formatBoolean boolean="${row.showInternal}" />\n          </td>\n        </tr>\n      </g:each>\n    </tbody>\n  </table>\n</div>\n<div class="buttons">\n  <eca:link controller="${params.prevController}" action="${params.prevAction}" id="${params.prevId}">\n    <g:message code="default.button.back.label" />\n  </eca:link>\n  <eca:link controller="${params.controller}" action="create" id="${params.id}">\n    <g:message code="default.button.create.label" />\n  </eca:link>\n</div>', 22, NULL, 1, 0),
(22, '<table domain="Equipment" index="true">	\r\n	<column name="code" />\r\n	<column name="equipment" />\r\n</table>\r\n\r\n<buttons>\r\n	<button type="back" />\r\n	<button action="create" />\r\n</buttons>\r\n', NULL, 23, NULL, 1, 0),
(24, '<table domain="Session" index="true">\r\n	<column name="code" />\r\n	<column name="name" /> \r\n</table>\r\n\r\n<buttons>\r\n	<button type="back" />\r\n	<button action="create" />\r\n</buttons>', '<div class="tbl_container">\n  <input type="hidden" name="default-action" value="show" />\n  <div class="tbl_toolbar right">\n    <span>Export data: </span>\n    <select class="export-data">\n      <option value="-1"> </option>\n      <option value="export=0&amp;format=csv&amp;sep=,">CSV (,)</option>\n      <option value="export=0&amp;format=csv&amp;sep=;">CSV (;)</option>\n      <option value="export=0&amp;format=csv&amp;sep=tab">CSV (tab)</option>\n      <option value="export=0&amp;format=xls">XLS</option>\n      <option value="export=0&amp;format=xml">XML</option>\n    </select>\n  </div>\n  <table class="clear">\n    <thead>\n      <tr>\n        <th class="counter"></th>\n        <th class="id hidden"></th>\n        <th class="sortable">\n          <eca:fallbackMessage code="session.code.label" fbCode="session.code.label" />\n          <eca:linkAllParams params="[''sort_0_code'': ''asc'']">\n            <g:img dir="images/skin" file="sorted_asc.gif" class="sort_asc" />\n          </eca:linkAllParams>\n          <eca:linkAllParams params="[''sort_0_code'': ''desc'']">\n            <g:img dir="images/skin" file="sorted_desc.gif" class="sort_desc" />\n          </eca:linkAllParams>\n        </th>\n        <th class="sortable">\n          <eca:fallbackMessage code="session.name.label" fbCode="session.name.label" />\n          <eca:linkAllParams params="[''sort_0_name'': ''asc'']">\n            <g:img dir="images/skin" file="sorted_asc.gif" class="sort_asc" />\n          </eca:linkAllParams>\n          <eca:linkAllParams params="[''sort_0_name'': ''desc'']">\n            <g:img dir="images/skin" file="sorted_desc.gif" class="sort_desc" />\n          </eca:linkAllParams>\n        </th>\n      </tr>\n      <tr>\n        <th class="counter"></th>\n        <th class="id hidden"></th>\n        <th class="filter" value="${params.filter_0_code}">\n          <input type="text" name="filter_0_code" value="${params.filter_0_code}" placeholder="Filter on ${eca.fallbackMessage(code: ''session.code.label'', fbCode: ''session.code.label'').toLowerCase()}" />\n        </th>\n        <th class="filter" value="${params.filter_0_name}">\n          <input type="text" name="filter_0_name" value="${params.filter_0_name}" placeholder="Filter on ${eca.fallbackMessage(code: ''session.name.label'', fbCode: ''session.name.label'').toLowerCase()}" />\n        </th>\n      </tr>\n    </thead>\n    <tbody>\n      <g:each in="${results.get(0).get()}" var="row" status="i">\n        <tr>\n          <td class="counter">${i+1}</td>\n          <td class="id hidden">\n            <g:fieldValue bean="${row}" field="id" />\n          </td>\n          <td>${row.code}</td>\n          <td>${row.name}</td>\n        </tr>\n      </g:each>\n    </tbody>\n  </table>\n</div>\n<div class="buttons">\n  <eca:link controller="${params.prevController}" action="${params.prevAction}" id="${params.prevId}">\n    <g:message code="default.button.back.label" />\n  </eca:link>\n  <eca:link controller="${params.controller}" action="create" id="${params.id}">\n    <g:message code="default.button.create.label" />\n  </eca:link>\n</div>', 26, NULL, 1, 0),
(25, '<form domain="Session" id="url">\r\n	<column name="id" />\r\n	<column name="name" />\r\n	<column name="code" />\r\n	<column name="comment" />\r\n	<column name="enabled" />\r\n	<column name="deleted" /> \r\n	\r\n	<button type="cancel" />\r\n	<button type="save" />  \r\n</form>', NULL, 27, NULL, 1, 0),
(26, '<form domain="Session">\r\n	<column name="name" />\r\n	<column name="code" />\r\n	<column name="comment" />\r\n	<column name="enabled" />\r\n	\r\n	<button type="cancel" />\r\n	<button type="save" />  \r\n</form>', '<g:hasErrors model="${results.get(0).model}">\n  <ul class="errors" role="alert">\n    <g:eachError model="${results.get(0).model}" var="error">\n      <li>\n        <g:message error="${error}" />\n      </li>\n    </g:eachError>\n  </ul>\n</g:hasErrors>\n<form method="post" action="#">\n  <input type="hidden" name="id" value="${results.get(0).get(''Session'').id}" />\n  <input type="hidden" name="eid" value="0" />\n  <fieldset class="form">\n    <div class="${hasErrors(bean: results.get(0).get(''Session''), field: ''name'', ''error'')} required">\n      <label class="property-label" for="Session.name">\n        <eca:fallbackMessage code="session.name.label" fbCode="session.name.label" />\n        <span class="required-indicator">*</span>\n      </label>\n      <input id="Session.name" maxlength="255" name="Session.name" value="${results.get(0).get(''Session'')?.name}" class="property-value" type="text" required="required" />\n    </div>\n    <div class="${hasErrors(bean: results.get(0).get(''Session''), field: ''code'', ''error'')} required">\n      <label class="property-label" for="Session.code">\n        <eca:fallbackMessage code="session.code.label" fbCode="session.code.label" />\n        <span class="required-indicator">*</span>\n      </label>\n      <input id="Session.code" maxlength="10" name="Session.code" value="${results.get(0).get(''Session'')?.code}" class="property-value" type="text" required="required" />\n    </div>\n    <div class="${hasErrors(bean: results.get(0).get(''Session''), field: ''comment'', ''error'')} ">\n      <label class="property-label" for="Session.comment">\n        <eca:fallbackMessage code="session.comment.label" fbCode="session.comment.label" />\n      </label>\n      <textarea id="Session.comment" cols="40" name="Session.comment" class="property-value" rows="5">${results.get(0).get(''Session'')?.comment}</textarea>\n    </div>\n    <div class="${hasErrors(bean: results.get(0).get(''Session''), field: ''enabled'', ''error'')} ">\n      <label class="property-label" for="Session.enabled">\n        <eca:fallbackMessage code="default.enabled.label" fbCode="session.enabled.label" />\n      </label>\n      <g:checkBox id="Session.enabled" name="Session.enabled" value="${results.get(0).get(''Session'')?.enabled}" class="property-value" />\n    </div>\n  </fieldset>\n  <fieldset class="buttons">\n    <eca:link controller="${params.prevController}" action="${params.prevAction}" id="${params.prevId}">\n      <g:message code="default.button.cancel.label" />\n    </eca:link>\n    <input type="submit" name="btn_save" class="btn_save" value="${message(code: ''default.button.save.label'')}" />\n  </fieldset>\n</form>', 28, NULL, 1, 0),
...
(32, '<form domain="EmailTemplate">\r\n	<column name="usedBy" />\r\n	<column name="subject" />\r\n	<column name="body" textarea="large" />\r\n	<column name="sender" />\r\n	<column name="comment" />\r\n	<column name="testAfterSave" />\r\n	<column name="testEmail" />\r\n	\r\n	<button type="cancel" />\r\n	<button type="save" />  \r\n</form>', NULL, 40, NULL, 1, 1),
(33, '<form domain="EmailTemplate" id="url">\r\n	<column name="id" />\r\n	<column name="usedBy" />\r\n	<column name="subject" />\r\n	<column name="body" textarea="large" />\r\n	<column name="sender" />\r\n	<column name="comment" />\r\n	<column name="testAfterSave" />\r\n	<column name="testEmail" />\r\n	<column name="enabled" />\r\n	<column name="deleted" />\r\n	\r\n	<button type="cancel" />\r\n	<button type="save" />  \r\n</form>', NULL, 41, NULL, 1, 1),
(34, '<table domain="EmailTemplate">\r\n	<column name="description" />\r\n	<column name="id" />\r\n</table>\r\n\r\n<buttons>\r\n	<button type="back" />\r\n	<button action="create" />\r\n</buttons>', '<div class="tbl_container">\n  <input type="hidden" name="default-action" value="show" />\n  <div class="tbl_toolbar right">\n    <span>Export data: </span>\n    <select class="export-data">\n      <option value="-1"> </option>\n      <option value="export=0&amp;format=csv&amp;sep=,">CSV (,)</option>\n      <option value="export=0&amp;format=csv&amp;sep=;">CSV (;)</option>\n      <option value="export=0&amp;format=csv&amp;sep=tab">CSV (tab)</option>\n      <option value="export=0&amp;format=xls">XLS</option>\n      <option value="export=0&amp;format=xml">XML</option>\n    </select>\n  </div>\n  <table class="clear">\n    <thead>\n      <tr>\n        <th class="sortable">\n          <eca:fallbackMessage code="emailTemplate.description.label" fbCode="emailtemplate.description.label" />\n          <eca:linkAllParams params="[''sort_0_description'': ''asc'']">\n            <g:img dir="images/skin" file="sorted_asc.gif" class="sort_asc" />\n          </eca:linkAllParams>\n          <eca:linkAllParams params="[''sort_0_description'': ''desc'']">\n            <g:img dir="images/skin" file="sorted_desc.gif" class="sort_desc" />\n          </eca:linkAllParams>\n        </th>\n        <th class="id sortable">#\n          <eca:linkAllParams params="[''sort_0_id'': ''asc'']">\n            <g:img dir="images/skin" file="sorted_asc.gif" class="sort_asc" />\n          </eca:linkAllParams>\n          <eca:linkAllParams params="[''sort_0_id'': ''desc'']">\n            <g:img dir="images/skin" file="sorted_desc.gif" class="sort_desc" />\n          </eca:linkAllParams>\n        </th>\n      </tr>\n      <tr>\n        <th class="filter" value="${params.filter_0_description}">\n          <input type="text" name="filter_0_description" value="${params.filter_0_description}" placeholder="Filter on ${eca.fallbackMessage(code: ''emailTemplate.description.label'', fbCode: ''emailtemplate.description.label'').toLowerCase()}" />\n        </th>\n        <th class="filter" value="${params.filter_0_id}" />\n      </tr>\n    </thead>\n    <tbody>\n      <g:each in="${results.get(0).get()}" var="row" status="i">\n        <tr>\n          <td>${row.description}</td>\n          <td class="id">\n            <g:fieldValue bean="${row}" field="id" />\n          </td>\n        </tr>\n      </g:each>\n    </tbody>\n  </table>\n</div>\n<div class="buttons">\n  <eca:link controller="${params.prevController}" action="${params.prevAction}" id="${params.prevId}">\n    <g:message code="default.button.back.label" />\n  </eca:link>\n  <eca:link controller="${params.controller}" action="create" id="${params.id}">\n    <g:message code="default.button.create.label" />\n  </eca:link>\n</div>', 42, NULL, 1, 0),
(35, '<overview domain="EmailTemplate" id="url">\r\n	<column name="id" />\r\n	<column name="description" />\r\n	<column name="subject" />\r\n	<column name="body" />\r\n	<column name="sender" />\r\n	<column name="comment" />\r\n	<column name="enabled" />\r\n	<column name="deleted" />\r\n</overview>\r\n\r\n<buttons>\r\n        <button type="back" />\r\n        <button action="edit" />\r\n</buttons>', '<ol class="property-list">\n  <li>\n    <span id="id-label" class="property-label">#</span>\n    <span class="property-value" arial-labelledby="id-label">\n      <eca:formatText text="${results.get(0).get(''EmailTemplate'')[''id'']}" />\n    </span>\n  </li>\n  <li>\n    <span id="description-label" class="property-label">\n      <eca:fallbackMessage code="emailTemplate.description.label" fbCode="emailtemplate.description.label" />\n    </span>\n    <span class="property-value" arial-labelledby="description-label">\n      <eca:formatText text="${results.get(0).get(''EmailTemplate'')[''description'']}" />\n    </span>\n  </li>\n  <li>\n    <span id="subject-label" class="property-label">\n      <eca:fallbackMessage code="emailTemplate.subject.label" fbCode="emailtemplate.subject.label" />\n    </span>\n    <span class="property-value" arial-labelledby="subject-label">\n      <eca:formatText text="${results.get(0).get(''EmailTemplate'')[''subject'']}" />\n    </span>\n  </li>\n  <li>\n    <span id="body-label" class="property-label">\n      <eca:fallbackMessage code="emailTemplate.body.label" fbCode="emailtemplate.body.label" />\n    </span>\n    <span class="property-value" arial-labelledby="body-label">\n      <eca:formatText text="${results.get(0).get(''EmailTemplate'')[''body'']}" />\n    </span>\n  </li>\n  <li>\n    <span id="sender-label" class="property-label">\n      <eca:fallbackMessage code="emailTemplate.sender.label" fbCode="emailtemplate.sender.label" />\n    </span>\n    <span class="property-value" arial-labelledby="sender-label">\n      <eca:formatText text="${results.get(0).get(''EmailTemplate'')[''sender'']}" />\n    </span>\n  </li>\n  <li>\n    <span id="comment-label" class="property-label">\n      <eca:fallbackMessage code="emailTemplate.comment.label" fbCode="emailtemplate.comment.label" />\n    </span>\n    <span class="property-value" arial-labelledby="comment-label">\n      <eca:formatText text="${results.get(0).get(''EmailTemplate'')[''comment'']}" />\n    </span>\n  </li>\n  <li>\n    <span id="enabled-label" class="property-label">\n      <eca:fallbackMessage code="default.enabled.label" fbCode="emailtemplate.enabled.label" />\n    </span>\n    <span class="property-value" arial-labelledby="enabled-label">\n      <g:checkBox name="enabled" value="${results.get(0).get(''EmailTemplate'')[''enabled'']}" disabled="true" />\n    </span>\n  </li>\n  <li>\n    <span id="deleted-label" class="property-label">\n      <eca:fallbackMessage code="default.deleted.label" fbCode="emailtemplate.deleted.label" />\n    </span>\n    <span class="property-value" arial-labelledby="deleted-label">\n      <g:checkBox name="deleted" value="${results.get(0).get(''EmailTemplate'')[''deleted'']}" disabled="true" />\n    </span>\n  </li>\n</ol>\n<div class="buttons">\n  <eca:link controller="${params.prevController}" action="${params.prevAction}" id="${params.prevId}">\n    <g:message code="default.button.back.label" />\n  </eca:link>\n  <eca:link controller="${params.controller}" action="edit" id="${params.id}">\n    <g:message code="default.button.edit.label" />\n  </eca:link>\n</div>', 43, NULL, 1, 0),
...
(8, 4, 'Mail new registrations for Chairs', 'Mail new registrations for Chairs', 'Mail new registrations for Chairs', 'eca', '', NULL, 80, 1, NULL, 1, 0),
(98, 4, 'Test email', 'Test', 'Dear [NameParticipant],\r\n\r\nYour email address is [EmailParticipant]!\r\nAnd your participant data is:\r\n[ParticipantData]\r\n\r\nBut your paper data is:\r\n[PaperData]\r\n\r\nAnd your networks are:\r\n[NetworkName]\r\n\r\nWith kind regards,\r\n[NameParticipant]', 'Me', '', NULL, 998, 1, NULL, 1, 0),
(99, 4, 'Composed email', 'subject', 'Some message', 'Me', '', NULL, 999, 1, 'Some comments', 1, 0);
...
CREATE TABLE IF NOT EXISTS `sent_emails` (
  ...
  `from_email` varchar(30) collate utf8_unicode_ci NOT NULL,
  `subject` varchar(78) collate utf8_unicode_ci NOT NULL,
  `body` text collate utf8_unicode_ci NOT NULL,
...
(8, 'email_min_millisec_between_sending', '900000', NULL, 1, 0),
(9, 'email_max_num_emails_per_session', '200', NULL, 1, 0),
(10, 'disable_email_sessions', '1', NULL, 1, 0);
...
(1, 'testeca1@knoex.com', 'Lastname', 'Firstname', 'M', 'null', NULL, 'City', 169, 'en', '230e337572084fc40fdc869f53deadeff591861428a2ed1b48f267565c3c1f58f41b49aa671cc9d2e5de9a35b7285a8786192a0da646cd48d9d0c1be4e7a5819', 'l806hw0aJp6PcXKh3aelytHM0C', NULL, NULL, NULL, 'International Institute for Social History', 'Department', NULL, '2012-04-26', 1, 0),
(2, 'testeca2@knoex.com', 'Jan', 'Jansen', 'F', 'Mr.', NULL, 'City', 1, 'nl', 'pw', NULL, NULL, NULL, NULL, 'organisation', 'department', NULL, '2012-04-26', 1, 0),
(3, 'testeca3@knoex.com', 'Kees', 'Kees', 'F', NULL, NULL, 'Another City', 1, 'en', 'pw', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2012-04-26', 1, 0),
(4, 'testeca4@knoex.com', 'Joost', 'Joost', 'M', NULL, NULL, 'City', 169, 'nl', 'password', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2012-04-26', 1, 0),
(5, 'testeca5@knoex.com', 'Piet', 'Piet', NULL, NULL, NULL, 'CIty', 9, 'nl', 'password', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2012-04-26', 1, 0),
(6, 'testeca6@knoex.com', 'Henk', 'Henk', NULL, NULL, NULL, 'City', 12, 'nl', 'pass', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2012-04-26', 1, 0),
(7, 'testeca7@knoex.com', 'Jaap', 'Jaap', 'M', NULL, NULL, 'City', 98, 'nl', 'pw', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2012-04-26', 1, 0);
